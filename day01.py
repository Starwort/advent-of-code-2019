...
# fmt: off
# one-liner
print(sum([i // 3 - 2 for i in ints])) or ((get_fuel_1l := lambda mass: ((rv := max(mass//3-2, 0)) + (get_fuel_1l(rv) if rv else 0))) and print(sum([get_fuel_1l(i) for i in ints])))  # type: ignore
# true one-liner
